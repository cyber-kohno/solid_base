...
const RootFrame = () => {
    ...
    return <>
        ...
        <_MainDiv>
            <_OutlineDiv><OutlineFrame /></_OutlineDiv>
            <_TimelineDiv><TimelineFrame /></_TimelineDiv>
        </_MainDiv>
    </>;
}
